...
public class PullToRefreshActivity extends ActionBarActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private LoaderManager.LoaderCallbacks<List<Item>> mLoaderCallbacks = new LoaderManager.LoaderCallbacks<List<Item>>() {
        ...
        public Loader<List<Item>> onCreateLoader(int id, Bundle args) {
            return new AsyncTaskLoader<List<Item>>(PullToRefreshActivity.this) {
                @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pull_to_refresh_grid_activity);

        final StaggeredGridView listView = (StaggeredGridView) findViewById(android.R.id.list);
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.staggered_pull_to_refresh);
